package org.dobots.meanandvariancemodule.aim;
...
public class MeanAndVarianceModuleService extends Service {
	private static final String TAG = "MeanAndVarianceModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			MeanAndVarianceModule aim = new MeanAndVarianceModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("MeanAndVarianceModule");
	}
