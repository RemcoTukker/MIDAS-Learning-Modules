package org.dobots.meanandvariancemodule;
...
import org.dobots.meanandvariancemodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "MeanAndVarianceModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.meanandvariancemodule", "org.dobots.meanandvariancemodule.aim.MeanAndVarianceModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (MeanAndVarianceModuleService.class.getName().equals(service.service.getClassName())) {
